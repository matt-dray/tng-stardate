...
* iterative over text files -- containing *Star Trek: The Next Generation scripts* -- to extract stardates using the `purrr` and `stringr` packages
* web scrape episode names using the `rvest` package
